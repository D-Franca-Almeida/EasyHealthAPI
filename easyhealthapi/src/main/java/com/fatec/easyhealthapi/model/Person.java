...
public abstract class Person { // Tornando a classe abstrata, pois ela não deve ser instanciada diretamente
    ...
    public EasyHealthStatus getStatus() { return status; }
    public void setStatus(EasyHealthStatus status) { this.status = status; }
